  ...
  return (
    <div className="mb-3 px-2 space-y-1">
      <div className="flex items-center justify-between text-[13px] font-medium text-white/90">
        ...
        >
          <option value="subjective" className="bg-black text-white">Subjective (Theory / Essay)</option>
          ...
          <option value="sqlite3" className="bg-black text-white">SQLite 3</option>
          <option value="docker" className="bg-black text-white">Docker</option>
