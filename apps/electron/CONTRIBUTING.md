...
- Test thoroughly on macOS, especially for features like screenshot capture or AI integration.
...
- Test your changes locally using the provided `stealth-run.sh` script.
