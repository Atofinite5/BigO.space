...
>
> The configuration file is stored at: `/Users/[USERNAME]/Library/Application Support/interview-coder-v1/config.json`
...
- Move Window Left: [Control or Cmd + Shift + L]
- Move Window Right: [Control or Cmd + Shift + R]
- Move Window Up: [Control or Cmd + U]
- Move Window Down: [Control or Cmd + D]
- Take Screenshot: [Control or Cmd + H]
- Delete Last Screenshot: [Control or Cmd + Backspace]
- Process Screenshots: [Control or Cmd + Enter]
- Clear Queue & Reset: [Control or Cmd + Shift + X]
...
- OpenAI API Key
- Screen Recording Permission for Terminal/IDE (macOS)
  1. Go to System Settings > Privacy & Security > Screen Recording
  2. Ensure the app has screen recording permission enabled
...
**IMPORTANT**: The application window will be invisible by default! Use Cmd+B to toggle visibility.
...
- **Common Issues**:
  ...
  - Use Cmd+B multiple times if the window doesn't appear
  - Adjust window opacity with Cmd+[ / Cmd+] if needed
